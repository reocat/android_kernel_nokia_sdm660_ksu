...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   := -Wall -fPIC -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89
...
KBUILD_CFLAGS   := -fPIC -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs \
